...
public class DateWeiboUtils {  
    ...
    public static String parseTime(String s) {  
        ...
        int day0 = currentCalendar.get(currentCalendar.DAY_OF_MONTH);
        ...
        if (currentCalendar.get(currentCalendar.DAY_OF_MONTH) - calendar.get(calendar.DAY_OF_MONTH) > 0)  
            return (currentCalendar.get(currentCalendar.DAY_OF_MONTH) - calendar.get(calendar.DAY_OF_MONTH)) + "天前";

...
public class CopyGridView implements OnItemClickListener {
	...
	private JHDSCopyAdapter lAdapter;
	private List<JHDSCopyModel> mLSList = new ArrayList<JHDSCopyModel>();
	...
	public CopyGridView(Activity act, int type) {
		super();
		this.mAct = act;
	...
	private void initView() {
		...
		lAdapter = new JHDSCopyAdapter(mAct, mLSList);

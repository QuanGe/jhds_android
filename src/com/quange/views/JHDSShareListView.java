...
public class JHDSShareListView extends MultiColumnListView implements OnScrollListener {
	...
	// -- footer view
	private JHDSShareListViewFooter mFooterView;
	 ...
	 * @param context
	 */
	public JHDSShareListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public JHDSShareListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public JHDSShareListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public void setPullLoadEnable(boolean enable) {
		...
		if (!mEnablePullLoad) {
			...
			mPullLoading = false;
			mFooterView.show();
			mFooterView.setState(JHDSShareListViewFooter.STATE_NORMAL);
	...
	private void updateHeaderHeight(float delta) {
		...
		if (mEnablePullRefresh && !mPullRefreshing) { // 未处于刷新状态，更新箭头
			if (mHeaderView.getVisiableHeight() > mHeaderViewHeight) {
				mHeaderView.setState(JHDSShareListViewHeader.STATE_READY);
			} else {
				mHeaderView.setState(JHDSShareListViewHeader.STATE_NORMAL);
			}
		}
	...
	private void updateFooterHeight(float delta) {
		...
		if (mEnablePullLoad && !mPullLoading) {
			if (height > PULL_LOAD_MORE_DELTA) { // height enough to invoke load
													// more.
				mFooterView.setState(JHDSShareListViewFooter.STATE_READY);
			} else {
				mFooterView.setState(JHDSShareListViewFooter.STATE_NORMAL);
			}
		}
	...
	private void startLoadMore() {
		mPullLoading = true;
		mFooterView.setState(JHDSShareListViewFooter.STATE_LOADING);

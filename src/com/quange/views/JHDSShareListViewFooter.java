...
public class JHDSShareListViewFooter extends LinearLayout {
	...
	public JHDSShareListViewFooter(Context context) {
		super(context);
		initView(context);
	}

	public JHDSShareListViewFooter(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
